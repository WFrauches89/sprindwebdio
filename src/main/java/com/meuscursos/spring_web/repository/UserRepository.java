package com.meuscursos.spring_web.repository;

import com.meuscursos.spring_web.entity.User;
import com.meuscursos.spring_web.exceptions.CamposObrigatoriosExceptions;
...
public class UserRepository {
    public void save(User user){
        ...
        if(user.getLogin()==null){
            throw new CamposObrigatoriosExceptions("login");
        }
        if(user.getPassword()==null){
            throw new CamposObrigatoriosExceptions("Password");
        }
